<template>
  <div class="page-wrap">
    ...
    >
      <template #toolbar>
        <el-button v-if="canDo('care:feeding:add')" type="primary" :icon="Plus" @click="openAdd">新增喂养记录</el-button>
      </template>
        ...
        <el-table-column label="操作" width="180" fixed="right" align="center">
          <template #default="{ row }">
            <div class="table-actions">
              <el-tooltip v-if="canDo('care:feeding:edit')" content="编辑" placement="top">
                <el-button circle size="small" :icon="Edit" @click="openEdit(row)" />
              </el-tooltip>
              <el-tooltip v-if="canDo('care:feeding:delete')" content="删除" placement="top">
...
const canSave = computed(() => form.id ? canDo('care:feeding:edit') : canDo('care:feeding:add'))
